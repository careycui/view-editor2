	...
	<div class="ft">
		...
		<div class="el-form-item">
			<el-row>
				<el-col :span="12">
					...
					<div class="el-form-item__content" style="margin-left:40px;">
						<el-input-number controls-position="right" v-model="data.fontSize" size="small" :max="180" :min="12"></el-input-number>
					</div>
				</el-col>
				<el-col :span="12">
					<label class="el-form-item__label" style="width:40px;">
					...
					<div class="el-form-item__content" style="margin-left:40px;">
						<el-input-number controls-position="right" v-model="data.lineHeight" size="small" :max="180" :min="12"></el-input-number>
					</div>
				</el-col>
			</el-row>
		</div>
		...
		<div class="el-form-item">
			...
			<div class="el-form-item__content" style="margin-left:40px;height:auto;overflow:hidden;">
				<el-color-picker size="small" v-model="data.color" show-alpha :predefine="predefineColors"></el-color-picker>
			</div>
		</div>
	</div>
</template>
<script>
	import { defaultColors } from './../../editor_components/color_picker'
	export default{
		name: 'ft',
		props:{
			value:{
