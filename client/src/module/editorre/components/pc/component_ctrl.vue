		...
		<div class="coms-panel__cnt">
			<div class="coms-panel__cnt-page"
				...
				<div class="page-tree_btns">
					<el-button type="primary" size="mini" icon="el-icon-plus" class="reset-br cntrl-btn" @click="addPage"></el-button>
					<el-button type="primary" size="mini" icon="el-icon-upload" class="reset-br cntrl-btn" @click="openUploadDialog"></el-button>
					<el-button type="primary" size="mini" class="reset-br cntrl-btn" @click="copyContainer">
						<i class="fa fa-copy"></i>
					</el-button>
					<el-button type="warning" size="mini" icon="el-icon-delete" class="reset-br cntrl-btn" @click="deleteContainerCom"></el-button>
					<el-button type="info" size="mini" class="reset-br cntrl-btn" @click="toggleComsPanel">
				...
				<transition name="fade">
					<div class="coms-panel__cnt-item"
						:class="{ active: key === activePanel }" v-show="key === activePanel">
							<ul class="com-list" v-show="sc.coms.length>0">
				          	...
				          	<ul class="com-list" v-show="sc.coms.length<1">
		...
		<transition name="fade-right">
			<div class="children-panel" v-show="comsPanelActive">
				<div class="children-panel__header">
					<el-button type="primary" size="mini" @click="copyCom" class="cntrl-btn">
						<i class="fa fa-copy"></i>
					</el-button>
					<el-button type="primary" size="mini" @click="copyToClipboard" title="复制到粘贴板" class="cntrl-btn">
						<i class="fa" :class="{'fa-clipboard': !!!copy_com, 'fa-check': !!copy_com}"></i>
					</el-button>
					<el-button type="primary" size="mini" @click="insertTo" :disabled="!!!copy_com" title="插入复制内容" class="cntrl-btn">
						<i class="fa fa-indent"></i>
					</el-button>
					<el-button type="warning" icon="el-icon-delete" size="mini" @click="deleteCom" class="cntrl-btn"></el-button>
