		...
		<el-tabs v-model="acitveTab">
			<el-tab-pane label="内容&样式" name="style" class="editor-pane">
				...
				<div class="el-form-item">
					<label>链接</label>
					<div class="el-form-item__content">
						<el-input size="small" class="br2" v-model="data.link" placeholder="基本文本"></el-input>
					</div>
				</div>
				<div class="el-form-item">
					<label>目标</label>
				...
				<div class="tab-line">
					<div class="tab-line--title">位置</div>
				</div>
				<div class="el-form-item">
					...
					<el-row style="margin-left:40px;">
						<el-col :span="12">
							...
							<div class="el-form-item__content" style="margin-left:40px;">
								<el-input-number size="small" controls-position="right" :min="0" :max="100" v-model="data.style.width"></el-input-number>
							</div>
						</el-col>
						<el-col :span="12">
							<label class="el-form-item__label" style="width:40px;text-align:center;">H</label>
							<div class="el-form-item__content" style="margin-left:40px;">
								<el-input-number size="small" controls-position="right" :min="0" :max="100" v-model="data.style.height"></el-input-number>
							</div>
						</el-col>
					</el-row>
				</div>
				<div class="el-form-item">
					<label class="el-form-item__label" style="width:40px;">间距</label>
					<el-row style="margin-left:40px;">
						<el-col :span="12">
							<label class="el-form-item__label" style="width:40px;text-align:center;">L</label>
							<div class="el-form-item__content" style="margin-left:40px;">
								<el-input-number size="small" controls-position="right" :min="0" :max="100" v-model="data.style.left"></el-input-number>
							</div>
						</el-col>
						<el-col :span="12">
							<label class="el-form-item__label" style="width:40px;text-align:center;">T</label>
							<div class="el-form-item__content" style="margin-left:40px;">
								<el-input-number size="small" controls-position="right" :min="0" :max="100" v-model="data.style.top"></el-input-number>
							</div>
						</el-col>
					</el-row>
				</div>
